...
export class Traukiantis extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            gamintojas: '',
    ...
    axios.post("http://localhost:8081/train-app/vagonai/"+this.props.match.params.id+"/add/lokomotyvas/traukiantis", outputTrain)
        .then((response) => {
            this.setState( {
                gamintojas: '',
                kiekis: '',
